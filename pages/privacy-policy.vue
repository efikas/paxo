  ...
  <div>
    ...
    <v-container>
      ...
      <p>
        ...
        shared with any third party. Personal information collected online will
        only be disclosed within our corporate group for internal use only.
      </p>
      <p>
        We shall take all reasonable steps to protect your personal information.
        For the purpose of this clause, “personal information” shall be defined
        as detailed in the Promotion of Access to Information Act 2 of 2000
        (PAIA).
      </p>

      <p>
        The personal information we collect from you may be used in some or all
      ...
      <ul>
        ...
        <li>To provide you with relevant product information</li>
      </ul>
      <p>
        If you subscribe to our email newsletter we will also use your email
        address to send you promotional material. You can unsubscribe from
        marketing information at anytime by using the unsubscribe function
        within the email send to you. Updating your personal information.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Securely destroying your personal information when it is no longer
          needed for our record retention purposes.
        </li>
      </ul>
      <p>
      ...
      <h3 class="primary--text">Disclosure of personal information.</h3>
      <p>
      ...
      <p>
        This information is collected for analysis and evaluation purposes, in
        order to help us improve our site and the services and products we
        provide. This data will not be used in association with any other
        personal information. The data stored in these ‘cookies’ does not permit
        for any individual to be identified and hence cannot be linked back to
        one individual. Should you want to deactivate these cookies you can do
        so in your browser preferences.
      </p>
